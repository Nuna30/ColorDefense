...
void UCreepWayGeneratorManager::CreateCreepWayGenerator(UWorld* InWorld, UBPActorPool* InBPActorPool, UChunk* InChunk, int32 InMaxRailCount, int32 InRailLength)
{
