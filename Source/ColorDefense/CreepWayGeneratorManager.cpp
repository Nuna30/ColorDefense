...
void UCreepWayGeneratorManager::CreateCreepWayGenerator(UWorld* InWorld, UBPActorPool* InBPActorPool, UVoxelGrid* InVoxelGrid, UChunkGrid* InChunkGrid, TArray<UCreepCheckPointGenerator*>& InCreepCheckPointGenerators, int32 InMaxRailCount, int32 InRailLength, TArray<FIntVector>& DirectionContainer)
{
    ...
    // 3. 데이터 주입 및 초기화
    NewCreepWayGenerator->Initialize(InWorld, InBPActorPool, InVoxelGrid, InChunkGrid, InCreepCheckPointGenerators, InMaxRailCount, InRailLength, DirectionContainer);
